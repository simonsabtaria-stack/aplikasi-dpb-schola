...
bank_kurikulum = {
    ...
    "Fase A": {
        ...
        "Pendidikan Jasmani, Olahraga, dan Kesehatan (PJOK)": {
            "Terampil Bergerak": [{"cp": "Mempraktikkan keterampilan gerak fundamental dan menerapkannya dalam berbagai situasi gerak yang berbeda; mengeksplorasi strategi dan konsep gerak serta menyimpulkan efektivitasnya.", "materi": ["Keterampilan gerak fundamental (lokomotor, non-lokomotor, manipulatif)", "Eksplorasi berbagai strategi gerak", "Eksplorasi konsep gerak (tubuh, ruang, usaha, keterhubungan)"]}],
            "Belajar Melalui Gerak": [{"cp": "Menaati peraturan untuk menumbuhkan fair play di dalam berbagai aktivitas jasmani; menerapkan strategi kolaborasi.", "materi": ["Taat aturan untuk membentuk fair play", "Penerapan strategi gerak sederhana (menipu lawan, berlari zig-zag)", "Penerapan strategi kolaborasi"]}],
            "Bergaya Hidup Aktif": [{"cp": "Berpartisipasi di dalam berbagai aktivitas jasmani dan mengidentifikasi manfaatnya.", "materi": ["Partisipasi aktif dan identifikasi manfaat aktivitas jasmani (membuat sehat, kuat, senang, membantu berteman)"]}],
            "Memilih Hidup Menyehatkan": [{"cp": "Mengenali pentingnya gaya hidup aktif dan sehat, komponen makanan bergizi seimbang, serta praktik kesehatan dan keselamatan diri.", "materi": ["Pengenalan gaya hidup aktif dan sehat", "Makanan bergizi seimbang", "Praktik kesehatan dan keselamatan diri"]}]
        },
        "Seni Musik": {
    ...
    "Fase B": {
        ...
        "Pendidikan Jasmani, Olahraga, dan Kesehatan (PJOK)": {
            "Terampil Bergerak": [{"cp": "Menghaluskan keterampilan gerak fundamental di situasi baru; menyesuaikan strategi gerak; memperagakan konsep gerak dalam rangkaian gerak.", "materi": ["Penghalusan keterampilan gerak fundamental", "Penyesuaian strategi gerak", "Penerapan konsep gerak (tubuh, ruang, usaha, keterhubungan)"]}],
            "Belajar Melalui Gerak": [{"cp": "Menerapkan strategi gerak sederhana & memecahkan masalah gerak; menerapkan peraturan untuk fair play; berpartisipasi secara positif dalam tim.", "materi": ["Penerapan strategi gerak sederhana & pemecahan masalah gerak", "Penerapan peraturan konsisten untuk fair play", "Partisipasi positif dalam kelompok/tim"]}],
            "Bergaya Hidup Aktif": [{"cp": "Berpartisipasi dalam berbagai aktivitas jasmani dan mengenali faktor-faktor yang menyebabkan aktivitas jasmani menyenangkan.", "materi": ["Partisipasi aktif dan pengenalan faktor yang menyebabkan aktivitas jasmani menjadi menyenangkan"]}],
            "Memilih Hidup Menyehatkan": [{"cp": "Mengenali risiko kesehatan gaya hidup; mengidentifikasi pola makan sehat sesuai rekomendasi; mempraktikkan penanganan cedera ringan.", "materi": ["Identifikasi makanan sehat dan bergizi seimbang sesuai rekomendasi (isi piringku)", "Praktik penanganan cedera ringan"]}]
        },
        "Seni Musik": {
    ...
    "Fase C": {
        ...
        "Pendidikan Jasmani, Olahraga, dan Kesehatan (PJOK)": {
            "Terampil Bergerak": [{"cp": "Menyesuaikan keterampilan gerak melintasi berbagai situasi; mentransfer strategi gerak; menginvestigasi konsep gerak.", "materi": ["Penyesuaian penggunaan keterampilan gerak melintasi berbagai situasi", "Transfer strategi gerak", "Investigasi konsep gerak untuk optimalisasi performa"]}],
            "Belajar Melalui Gerak": [{"cp": "Menguji efektivitas penerapan strategi gerak; merancang peraturan alternatif & modifikasi permainan; menjalankan peran untuk keberhasilan tim.", "materi": ["Pengujian efektivitas strategi dan taktik", "Rancangan peraturan baru untuk fair play dan inklusivitas", "Pelaksanaan berbagai peran untuk tim"]}],
            "Bergaya Hidup Aktif": [{"cp": "Berpartisipasi aktivitas jasmani, menjelaskan pengaruh keteraturan terhadap kesehatan, mengidentifikasi rekomendasi aktivitas & cegah sedenter.", "materi": ["Partisipasi aktif dan penjelasan pengaruh aktivitas teratur terhadap kesehatan", "Identifikasi rekomendasi aktivitas jasmani"]}],
            "Memilih Hidup Menyehatkan": [{"cp": "Menghubungkan gaya hidup, risiko kesehatan & pencegahannya; menjelaskan pola makan sehat; mempraktikkan penanganan cedera sedang (RICE).", "materi": ["Identifikasi hubungan gaya hidup, risiko, & pencegahan", "Penjelasan pola makan sehat bergizi", "Praktik penanganan cedera sedang (prinsip RICE)"]}]
        },
        "Seni Musik": {
    ...
    "Fase D": {
        ...
        "Pendidikan Jasmani, Olahraga, dan Kesehatan (PJOK)": {
            "Terampil Bergerak": [{"cp": "Menerapkan keterampilan gerak serta mentransfernya ke berbagai situasi gerak; memperagakan strategi gerak untuk peningkatan capaian.", "materi": ["Penerapan teknik dasar olahraga", "Transfer keterampilan gerak dalam jenis aktivitas berbeda", "Peragaan strategi gerak"]}],
            "Belajar Melalui Gerak": [{"cp": "Membuktikan strategi gerak efektif; menginvestigasi modifikasi peraturan fair play & inklusif; menerapkan kepemimpinan, kolaborasi, & keputusan tim.", "materi": ["Pembuktian efektivitas strategi/taktik di konteks berbeda", "Investigasi peraturan fair play & inklusivitas", "Penerapan kepemimpinan, kolaborasi & pengambilan keputusan"]}],
            "Bergaya Hidup Aktif": [{"cp": "Berpartisipasi aktivitas jasmani & menjelaskan reaksi tubuh pada berbagai intensitas; menjelaskan strategi peningkatan aktivitas & cegah sedenter.", "materi": ["Partisipasi dan penjelasan reaksi tubuh terhadap berbagai tingkat intensitas", "Penjelasan strategi peningkatan aktivitas jasmani"]}],
            "Memilih Hidup Menyehatkan": [{"cp": "Menganalisis risiko kesehatan gaya hidup & merancang pencegahannya; merancang pola makan sehat sesuai gizi; mempraktikkan prosedur cedera.", "materi": ["Analisis risiko kesehatan & rancangan aktivitas pencegahan", "Rancangan pola makan sehat", "Praktik penanganan cedera risiko tinggi dengan pertolongan pertama"]}]
        },
        "Informatika": {
